      ...
      <div style={{background:"#fff",borderRadius:16,width:"100%",maxWidth:640,maxHeight:"92vh",overflowY:"auto",boxShadow:"0 24px 64px rgba(0,0,0,0.18)",display:"flex",flexDirection:"column"}} onClick={e=>e.stopPropagation()}>
        ...
        <div style={{padding:"18px 22px",borderBottom:"0.5px solid #e5e5e5",display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexShrink:0}}>
          ...
          <div style={{display:"flex",alignItems:"center",gap:8,flexShrink:0,marginLeft:12}}>
            ...
            {/* BOTÃO REENRIQUECER */}
            <button onClick={()=>onEnrich(company,null)} disabled={isEnriching} title="Actualizar dados" style={{padding:"5px 10px",borderRadius:7,border:"0.5px solid #ddd",background:"#fff",cursor:isEnriching?"wait":"pointer",fontSize:12,color:"#888"}}>
              {isEnriching ? "⏳" : "↺"}
            </button>
...
function AppShell() {
  ...
  async function enrichCompany(company, icpProfile = null) {
    ...
    try {
      ...
      try { await loadCompanies(); } catch(e) { console.error("loadCompanies error:", e); }
    }
  }
                  ...
                  return(
                    <div key={c.id}
                      ...
                      <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",borderTop:"0.5px solid #f5f5f4",paddingTop:8}}>
                        ...
                        <button
                          onClick={e=>{e.stopPropagation();enrichCompany(c,icpProfile);}}
                          disabled={isEnr}
